...
const Navbar = ({ }: Props) => {
    return (
        <section>
            {/* Top Newsletter Bar */}
            <p className='flex items-center justify-center text-[18px] text-[#98989A] px-[24px] py-[12px]'>
                Subscribe to our Newsletter For New & latest Blogs and Resources{' '}
                <GoArrowUpRight color='#FFD11A' />
            </p>

            {/* Navbar */}
            <div className='flex items-center justify-between px-[80px] py-[20px] bg-[#1A1A1A] border-[#7E7E81]'>
